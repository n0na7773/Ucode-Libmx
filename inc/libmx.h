...
char *mx_nbr_to_hex(unsigned long nbr); // 80 REMAKE
...
char **mx_strsplit(const char *s, char c); // FAIL done 
char *mx_strjoin(const char *s1, const char *s2); // 50 REMAKE done 
